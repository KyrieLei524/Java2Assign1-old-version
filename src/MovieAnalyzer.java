...
//        System.out.println(movieList.get(0).getGenre());
//        System.out.println(a.getMovieCountByYear());
        System.out.println(a.getMovieCountByGenre());
//        System.out.println(a.getMovieCountByGenre());
//        System.out.println(a.getCoStarCount().size());
//        for(int i = 0;i < 500; i++){
//            String title = movieList.get(i).Series_Title;
//            String time = movieList.get(i).Runtime;
//            String regEx="[^0-9]";
...
//        }
//        for(int i = 0;i < 500; i++){
//            System.out.println(movieList.get(i).Gross);
//        }
//        a.getTopStars(501, "gross");
